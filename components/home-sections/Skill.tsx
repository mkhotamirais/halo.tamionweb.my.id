...
import { skills } from "@/lib/menu";
import { motion, useInView } from "framer-motion";
import { useRef } from "react";
import SkillsCard from "./SkillItems";
import { Skill as SkillType } from "@/lib/menu-types";
...
export const SkillsItem = ({ skills, title }: { skills: SkillType[]; title: string }) => {
